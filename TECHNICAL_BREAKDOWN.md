...
The CLI now shares:
- a common shell for `--json`, `--fixture`, and `--rpc-url` handling
- fixture-driven command execution where scenarios are available
- severity-based exit-code mapping derived from the shared diagnostic taxonomy

## Reliability Lab

The Reliability Lab currently provides:
- scenario discovery from the shared fixture corpus
- diagnostic report rendering over shared SDK fixture execution
- payment explanation and route/liquidity explanation panels
- packaged HTML document rendering for the Lab surface
